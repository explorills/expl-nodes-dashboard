...
export default function DashboardDefault() {
  ...
  return (
    <Box sx={{ position: 'relative' }}>
      <Grid container rowSpacing={4.5} columnSpacing={2.75} sx={{ filter: 'blur(20px)', pointerEvents: 'none', userSelect: 'none' }}>
      {/* row 1 */}
            ...
            <Grid container sx={{ alignItems: 'center', justifyContent: 'space-between' }}>
              ...
              <Grid>
                <AvatarGroup sx={{ '& .MuiAvatar-root': { width: 32, height: 32 } }}>
                  <Avatar alt="User 1"><UserOutlined /></Avatar>
                  <Avatar alt="User 2"><UserOutlined /></Avatar>
                  <Avatar alt="User 3"><UserOutlined /></Avatar>
                  <Avatar alt="User 4"><UserOutlined /></Avatar>
                </AvatarGroup>
              </Grid>
            </Grid>
